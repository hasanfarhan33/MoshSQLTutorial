...
INSERT INTO `clients` VALUES (1, 'Vinte', '3 Nevada Parkway', 'Sycaruse', 'NY', '4827294810'); 
INSERT INTO `clients` VALUES (2, 'MyWorks', '3423 Glendale Parkway', 'Huntington', 'NY', '9482859439'); 
INSERT INTO `clients` VALUES (3, 'Yadel', '096 Pauling Parkway', 'San Fransisco', 'CA', '3195859865'); 
INSERT INTO `clients` VALUES (4, 'Kwideo', '81674 Westerfield Circle', 'Waco', 'TX', '8718975184'); 
INSERT INTO `clients` VALUES (5, 'TopicLounge', '0836 Farmco Road', 'Portland', 'OR', '7455522583'); 
...
CONSTRAINT `fk_order_statuses` FOREIGN KEY (`status`) REFERENCES `order_statuses` (`order_status_id`) ON UPDATE CASCADE,
CONSTRAINT `fk_order_shippers` FOREIGN KEY (`shipper_id`) REFERENCES `shippers` (`shipper_id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci; 
...
CONSTRAINT `fk_employees_offices` FOREIGN KEY (`office_id`) REFERENCES `offices` (`offices_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET =utf8mb4 COLLATE=utf8mb4_0900_ai_ci; 
